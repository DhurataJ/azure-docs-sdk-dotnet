---
title: Azure Dashboard Management client library for .NET
keywords: Azure, dotnet, SDK, API, Azure.ResourceManager.Dashboard, dashboard
author: AlexGhiondea
ms.author: alexghi
ms.date: 03/29/2022
ms.topic: reference
...
---
# Azure Dashboard Management client library for .NET - Version 1.0.0-alpha.20220329.1 
...
Install the Azure Dashboard management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.Dashboard -Version 1.0.0-beta.1 
```
