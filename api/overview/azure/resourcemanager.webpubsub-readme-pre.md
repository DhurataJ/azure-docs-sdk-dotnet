...
keywords: Azure, dotnet, SDK, API, Azure.ResourceManager.WebPubSub, azure.resourcemanager.webpubsub
author: vicancy
ms.author: lianwei
ms.date: 03/11/2022
ms.topic: reference
...
ms.technology: azure
ms.devlang: dotnet
ms.service: azure.resourcemanager.webpubsub
---
# Azure WebPubSub Management client library for .NET - Version 1.0.0-alpha.20220310.1 
